...
Insert into PREFERENCIA (TIPO,VALOR,ID_CLIENTE) values ('Condicion','Efectivo','0');
Insert into PREFERENCIA (TIPO,VALOR,ID_CLIENTE) values ('Condicion','Parrilla','1');
Insert into PREFERENCIA (TIPO,VALOR,ID_CLIENTE) values ('Condicion','Tarjeta de credito','2');
...
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-04 03:12:46','YYYY-MM-DD HH24:MI:SS'),'0','8','1');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-04 03:12:49','YYYY-MM-DD HH24:MI:SS'),'34','9','1');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-04 03:12:52','YYYY-MM-DD HH24:MI:SS'),'35','10','1');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-04 03:12:55','YYYY-MM-DD HH24:MI:SS'),'38','11','1');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-04 03:12:57','YYYY-MM-DD HH24:MI:SS'),'37','12','1');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-03 20:01:37','YYYY-MM-DD HH24:MI:SS'),'3','3','0');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-03 21:59:42','YYYY-MM-DD HH24:MI:SS'),'1','1','1');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-03 22:02:32','YYYY-MM-DD HH24:MI:SS'),'2','2','0');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-04 22:02:47','YYYY-MM-DD HH24:MI:SS'),'4','4','0');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-02 04:02:57','YYYY-MM-DD HH24:MI:SS'),'31','5','1');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-02 05:03:10','YYYY-MM-DD HH24:MI:SS'),'32','6','1');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-01 15:03:21','YYYY-MM-DD HH24:MI:SS'),'33','7','0');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-04 12:52:00','YYYY-MM-DD HH24:MI:SS'),'0','18','1');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-04 09:26:00','YYYY-MM-DD HH24:MI:SS'),'2','24','1');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-04 09:26:00','YYYY-MM-DD HH24:MI:SS'),'2','25','0');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-09-24 05:10:12','YYYY-MM-DD HH24:MI:SS'),'1','13','1');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-01 05:10:21','YYYY-MM-DD HH24:MI:SS'),'1','14','1');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-02 07:10:28','YYYY-MM-DD HH24:MI:SS'),'1','15','1');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-04 05:10:35','YYYY-MM-DD HH24:MI:SS'),'1','16','0');
Insert into PEDIDO (FECHAHORA,ID_CLIENTE,ID,SERVIDO) values (to_date('2017-10-03 05:10:40','YYYY-MM-DD HH24:MI:SS'),'1','17','0');
...
Insert into CONDICION (NOMBRE_CONDICION,ID_ESPACIO) values ('Barra salad','1');
Insert into CONDICION (NOMBRE_CONDICION,ID_ESPACIO) values ('Efectivo','1');
...
Insert into CONDICION (NOMBRE_CONDICION,ID_ESPACIO) values ('Tarjeta crédito','5');
...
Insert into PEDIDO_MENUS (ID_PEDIDO,ID_MENU,CANTIDAD) values ('1','1','1');
Insert into PEDIDO_MENUS (ID_PEDIDO,ID_MENU,CANTIDAD) values ('2','2','3');
Insert into PEDIDO_MENUS (ID_PEDIDO,ID_MENU,CANTIDAD) values ('3','1','1');
Insert into PEDIDO_MENUS (ID_PEDIDO,ID_MENU,CANTIDAD) values ('4','3','5');
Insert into PEDIDO_MENUS (ID_PEDIDO,ID_MENU,CANTIDAD) values ('5','4','1');
Insert into PEDIDO_MENUS (ID_PEDIDO,ID_MENU,CANTIDAD) values ('24','1','1');
Insert into PEDIDO_MENUS (ID_PEDIDO,ID_MENU,CANTIDAD) values ('24','2','1');
INSERT INTO PEDIDO_MENU  (ID_PEDIDO, ID_MENU, CANTIDAD) VALUES ('13', '1', '12')
INSERT INTO PEDIDO_MENU  (ID_PEDIDO, ID_MENU, CANTIDAD) VALUES ('14', '2', '2')
INSERT INTO PEDIDO_MENU (ID_PEDIDO, ID_MENU, CANTIDAD) VALUES ('15', '3', '3')
INSERT INTO PEDIDO_MENU (ID_PEDIDO, ID_MENU, CANTIDAD) VALUES ('15', '2', '4')
