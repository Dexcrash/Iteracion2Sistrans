...
public class RotondAndesTM {
	...
	public void addMenu(Menu menu) throws Exception {
		...
		try {
			...
			if (menu.getIdacompaÒamiento() != null)
				acompa = daoMenus.buscarProductoPorId(menu.getIdacompaÒamiento());
			...
			if (acompa != null) {
				if (acompa.getIdRestaurante() != idres) {
					throw new Exception(
							"El restaurante " + idres + "  no tiene al producto con id " + menu.getIdacompaÒamiento());
				}
			}
			if (platof != null) {
	...
	/**
	 * M√©todo que modela la transacciÛn que retorna todos los productos
	 * @return ListaProductos - objeto que modela  un arreglo de videos. este arreglo contiene el resultado de la b√∫squeda
