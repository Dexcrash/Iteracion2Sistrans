	...
	public void addMenu(Menu menu) throws Exception {
		...
		try {
			...
			if (menu.getIdacompaÒamiento() != null)
				acompa = daoProductos.buscarProductoPorId(menu.getIdacompaÒamiento());
			...
			if (acompa != null) {
				if (acompa.getIdRestaurante() != idres) {
					throw new Exception("El restaurante no tiene al producto con id " + menu.getIdacompaÒamiento());
				}
			}
			if (platof != null) {
