...
public class Producto {
	...
	@JsonProperty(value = "maximoProductos")
	private Long maximoProductos;
	...
	public Producto(@JsonProperty(value = "id") Long id, @JsonProperty(value = "nombre") String nombre,
			@JsonProperty(value = "tipo") String tipo, @JsonProperty(value = "disponibles") Integer disponibles,
			...
			@JsonProperty(value = "traduccionDescripcion") String traduccion,
			@JsonProperty(value = "idRestaurante") Long idRestaurante,
			@JsonProperty(value = "maximoProductos") Long maximoProductos) {
		super();
		this.id = id;
		this.nombre = nombre;
		this.tipo = tipo;
	...
	public Long getMaximoProductos() {
		return maximoProductos;
	}

	public void setMaximoProductos(Long maximoProductos) {
		this.maximoProductos = maximoProductos;
	}
